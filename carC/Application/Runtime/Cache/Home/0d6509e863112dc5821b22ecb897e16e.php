...
<head>
    ...
    <link href="/carC/Public/js/nivo/nivo-slider.css" rel="stylesheet">
    <link href="/carC/Public/js/nivo/themes/default/default.css" rel="stylesheet">
    ...
    <script src="/carC/Public/js/nivo/jquery.nivo.slider.js"></script>
    <script src="/carC/Public/js/myJs.js"></script>
</head>
<body>
<div class="scrollBtn">
    <button>在线咨询</button>
        ...
        <div class="helloWord">
            ...
            <div class="rightMessage">
                <ul class="userUl">
                    ...
                    <li><a href="<?php echo U("Login/index");?>" class="loginLink" style="display: block;">登录</a></li>
    ...
    <div class="slider">
        <div id="page" class="slider-wrapper theme-default">
            <div class="nivoSlider">
                <img src="/carC/Public/imgs/slider1.jpg" data-thumb="../imgs/slider1.jpg"  data-transition="fold" />
                <img src="/carC/Public/imgs/slider2.jpg" data-thumb="../imgs/slider2.jpg"  data-transition="fold" />
                <img src="/carC/Public/imgs/slider3.jpg" data-thumb="../imgs/slider3.jpg"  data-transition="fold" />
            </div>
        </div>
    </div>
    ...
    <div class="saleCarsBg">
        <div class="conWidth">
            <div class="leftSelect">
                <div class="carTitle">
                    <img src="/carC/Public/imgs/fiveStart.png"/>
                ...
                <div class="choose">
                    <div class="carLogo">
                        <img src="/carC/Public/imgs/brand/logo_03.png"/>
                        <a>大众</a>
                    </div>
                    <div class="carLogo">
                        <img src="/carC/Public/imgs/brand/logo_07.png"/>
                        <a>宝马</a>
                    </div>
                    <div class="carLogo">
                        <img src="/carC/Public/imgs/brand/logo_05.png"/>
                        <a>奥迪</a>
                    </div>
                </div>
                <div class="carTitle">
            ...
            <div class="rightBuy">
                <div class="upBuy">
                    <p><img src="/carC/Public/imgs/radio.png"> 高级评估师免费股价</p>
                    <p><img src="/carC/Public/imgs/radio.png"> 线上和线下同步销售</p>
                    <p><img src="/carC/Public/imgs/radio.png"> 一站式办理交易过户</p>
                </div>
                <div class="buyCarBtn">
    ...
    <div class="content">
        <div class="topContent">
            <div class="recommend">
                <div class="recodTitle">
                    <h3>推荐车辆</h3>
                    <a>more <img class="findMore" src="/carC/Public/imgs/more.png"/></a>
                </div>
                <div class="scrollPic">
                    <a id="tunLeft"><div class="turnLeft"></div></a>
                    <div class="mainBorder">
                        <div class="main">
                            <img src="/carC/Public/imgs/data/22.png" />
                            <img src="/carC/Public/imgs/data/33.png" />
                            <img src="/carC/Public/imgs/data/44.png" />
                            <img src="/carC/Public/imgs/data/55.png" />
                            <img src="/carC/Public/imgs/gg.jpg" />
                            <img src="/carC/Public/imgs/data/44.png" />
                        </div>
                    </div>
                    <a id="tunRight"><div class="turnRight"></div></a>
                </div>
                <p><a class="allRemer">查看全部商家<img class="findMore" src="/carC/Public/imgs/more.png"/></a></p>
            </div>
        ...
        <div class="manyCars">
            <div class="thisBorder">
                <div class="imgTop">
                    <img src="/carC/Public/imgs/shop/10.jpg" />
                </div>
                ...
                <div class="Remafooter">
                    ...
                    <img src="/carC/Public/imgs/starWhite.png" /> <span class="getin">加入收藏</span>
                </div>
            </div>
            <div class="thisBorder">
                <div class="imgTop">
