...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/cars/Public/js/uploadify/uploadify.css"/>
    <script src="/cars/Public/css/bootstrap/js/jquery-1.11.1.min.js"></script>
    <script src="/cars/Public/js/HomeRegister.js"></script>
    <script src="/cars/Public/css/bootstrap/js/bootstrap.min.js"></script>
    <script src="/cars/Public/js/uploadify/jquery.uploadify.min.js" type="text/javascript" charset="utf-8"></script>
    <script type="text/javascript">
    	...
    	var public ="/cars/Public";
    </script>
</head>
<body>
	<!--<img src=" /cars/Public/upload/2016-09-18/57deac4069143.jpg" />-->
<div class="scrollBtn">
    <button>在线咨询</button>
    <button>在线地图</button>
    ...
    <div class="helloWord">
        ...
        <div class="rightMessage">
            <ul class="userUl">
                ...
                <li><a href="" class="loginLink">登录</a></li>
                <li><a href="" class="regLink">注册</a></li>
...
<div class="advertisement">
    <a href=" "><img src="/cars/Public/imgs/ad.jpg" /></a>
    ...
    <div class="regMessage">
        <div class="regMain">
            ...
            <div id="userReg">
	            <form id="userRegister">
	                <div class="inpGrounp">
	                    ...
	                    <input name="userPhone" class="form-control" placeholder="请输入手机号..." />
	                </div>
	                <div class="inpGrounp">
	                ...
	                <div class="inpGrounp">
	                	<input name="RegisterRole" class="form-control" style="display: none;"/>
	                </div>
	                <button class="PerRegBtn">确认注册</button>
	                <div class="agreeBox">
	                    <input type="checkbox" /><span>我同意遵守《南鑫二手车协议》</span>
	                </div>
	            </form>
            </div>
            <form  class="companyReg"  method="post">
                ...
                <div class="agreeBox">
                    <input type="checkbox" /><span>我同意遵守《男信二手车协议》</span>
                </div>
            </form>
        </div>
    </div>
